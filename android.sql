...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2015 at 10:47 AM
...
--
ALTER TABLE `clipboard`
  MODIFY `index` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `notification`
--
ALTER TABLE `notification`
  MODIFY `index` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=131;
--
-- AUTO_INCREMENT for table `top`
--
ALTER TABLE `top`
  MODIFY `index` int(30) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=550;
